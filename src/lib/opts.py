  ...
  def __init__(self):
    ...
    self.parser.add_argument('--keep_res', action='store_true',
                             help='keep the original resolution'
                                  ' during validation.')
    # tracking
    self.parser.add_argument('--test_mot16', default=True, help='test mot16')
    ...
    self.parser.add_argument('--data_dir', type=str, default='/home/minhhuy/Desktop/Python/FairMOT/Data')
